...
public class Game extends Application implements GameEventListener {
    ...
    private void update(double delta) {
        ...
        if (currentLevel != null) {
            ...
            log.debug("Updated level with delta: " + delta);
        }
    }
    ...
    private void loadLevel(int levelNumber) {
        ...
        log.info("Loaded level " + levelNumber);
        resetPlayer();
    }

    public void restartLevel() {
        loadLevel(selectedLevel);
        log.info("Restarted level " + selectedLevel);
    }
    ...
    //zapsat do databaze pocet dokoncenych levelu a cas straveny na levelu
    @Override
    public void onLevelFinished() {
        ...
        javafx.application.Platform.runLater(() -> {
            ...
            try {
                ...
                e.printStackTrace();
                log.error("Failed to load level select screen: " + e);
            }});
